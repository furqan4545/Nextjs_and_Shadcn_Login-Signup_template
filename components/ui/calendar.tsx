...
import { SelectContent, SelectTrigger, Select, SelectItem } from "./select";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-medium hidden", //hidden is used to hide calendar label. Its a tailwind css property.
      ...
      components={{
        // CaptionLabel: () => null, // this is another way of hiding label.
